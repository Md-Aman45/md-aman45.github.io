...
> **Backend & Full-Stack Developer** graduating May 2026 (SGPA 8.89/10) with production experience shipping live applications using Node.js, Python, Java, and AWS — from LLM pipelines to microservices.

Built with **React + TypeScript + Tailwind CSS + Framer Motion** — fully responsive, dark mode, live LeetCode API, and WhatsApp contact form.
...
| Feature | Description |
|---|---|
| ⚡ **Live LeetCode API** | Real-time stats, heatmap & recent submissions |
| 🎠 **Project Carousel** | 5 projects with sliding animation & tabs |
| 🌙 **Dark / Light Mode** | Full theme toggle with smooth transition |
| 📱 **Fully Responsive** | Mobile-first with bottom tab navigation |
| 🖱️ **Custom Cursor** | Emerald dot + ring with hover expansion |
...
|---|---|---|---|
| 1 | **Interview AI** — GenAI mock interview platform | Node.js · Gemini · Groq · MongoDB · React | 🔨 In Progress |
| 2 | **GrowthAffinity** — Live MLM platform | Node.js · Redis · MongoDB · Microservices · AWS | [✅ Live](https://growthaffinitymarketing.com) |
| 3 | **Finance Dashboard API** — REST API with RBAC | Node.js · MongoDB · JWT · 3-tier RBAC | ✅ Complete |
| 4 | **Microservices Spring Boot** — Java architecture | Java · Spring Boot · Eureka · Spring Cloud | ✅ Complete |
| 5 | **Tradeflow** — Stock trading platform | Java · Spring Boot · PostgreSQL · Docker · Flutter | 🔨 In Progress |
...
```bash
git clone https://github.com/Md-Aman45/md-aman45.github.io.git
